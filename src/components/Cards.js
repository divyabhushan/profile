...
const dataset = [
  ...
  {link: 'techDocs', title: 'Technical Documentation', text: 'Develop clear, modular, rich content to explain technology in simpler ways. Agile methodology and software development practices to treat my data as a code and re-use it.', },
];
